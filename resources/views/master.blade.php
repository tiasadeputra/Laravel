...
<head>
    ...
    <link href="../public/css/cgx.css" rel="stylesheet">
...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demos"><i class="fa fa-database"></i> Master Data <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demos" class="collapse">
                            <li>
                                <a href="{{ URL::to('mitra') }}">Master Bussines Partner</a>
                            </li>
                            <li>
    ...
    <script src="../public/js/jquery.keyfilter.js"></script>
